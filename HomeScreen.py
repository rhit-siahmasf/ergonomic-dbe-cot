...
# util class
my_utilities = um.UtilManager(master)
frame.pack()
arm_wrist_screen_A1 = []
arm_wrist_screen_A2 = []
arm_wrist_screen_A3 = []
...
#    print('FileName:' + filename)
    ...
    easel.image = img
    my_utilities.attach_image_main(easel)
...
a1_step_screen = sm.ScreenManager(master, a_arm_title, 'Step 1: Locate upper arm position.', a1_step_images,
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(arm_wrist_screen_A2, 'Step 2A')], a1_step_options,
                                  arm_wrist_screen_A1)
...
a2_step_screen = sm.ScreenManager(master, a_arm_title, 'Step 2: Locate lower arm position.', a2_step_images,
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(arm_wrist_screen_A3, 'Step 3A')], a2_step_options,
                                  arm_wrist_screen_A2)
...
a3_step_screen = sm.ScreenManager(master, a_arm_title, 'Step 3: Locate wrist position.', a3_step_images,
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(arm_wrist_screen_A4, 'Step 4A'),
                                   my_utilities.attach_to_main(arm_wrist_screen_A5, 'Step 5A'),
                                   my_utilities.attach_to_main(arm_wrist_screen_A6, 'Step 6A')], a3_step_options,
                                  arm_wrist_screen_A3)
...
a6_step_screen = sm.ScreenManager(master, '', 'Step 6: Muscle use', [],
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(arm_wrist_screen_A7, 'Step 7A')],
...
a7_step_screen = sm.ScreenManager(master, a_arm_title, 'Step 7: Add force/load', [],
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(leg_trunk_screen_B1, 'Step 9B')],
...
b1_step_screen = sm.ScreenManager(master, b_trunk_title, 'Step 9: Locate Neck Position.', b1_step_images,
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(leg_trunk_screen_B2, 'Step 10B')], b1_step_options,
                                  leg_trunk_screen_B1)
...
b2_step_screen = sm.ScreenManager(master, b_trunk_title, 'Step 10: Locate Trunk Position.', b2_step_images,
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(leg_trunk_screen_B3, 'Step 11B'),
                                   my_utilities.attach_to_main(leg_trunk_screen_B4, 'Step 12B'),
                                   my_utilities.attach_to_main(leg_trunk_screen_B5, 'Step 13B')],
...
b5_step_screen = sm.ScreenManager(master, '', 'Step 13: Add Muscle Score.', [],
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(leg_trunk_screen_B6, 'Step 14B')], b5_step_options,
                                  leg_trunk_screen_B5)
# Step B14 -----------------------------------------------------------------------------------------------
...
b6_step_screen = sm.ScreenManager(master, b_trunk_title, 'Step 14: Add Force / Load Score', [],
                                  [my_utilities.clear_screen(),
                                   my_utilities.attach_to_main(conclusion_screen, 'Final Screen')],
...
back_button = tk.Button(master, text='BACK', highlightbackground='green',
                        command=lambda: [my_utilities.clear_screen(),
                                         my_utilities.attach_to_main(selection_screen, "Selection Screen")])
...
continue_button = tk.Button(master, text='Contiue',
                            command=lambda: [my_utilities.clear_screen(),
                                             my_utilities.attach_to_main(arm_wrist_screen_A1, "Screen A1")])
...
start_selection = tk.Button(master, text='NEXT', highlightbackground='#000fff000',
                            command=lambda: [my_utilities.clear_screen(), set_selection(),
                                             my_utilities.attach_to_main(image_selection, "Image Selector")])
...
my_utilities.attach_to_main(home_screen, "Home Screen")
