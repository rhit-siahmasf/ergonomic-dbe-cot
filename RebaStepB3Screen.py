...
def create_page(master):
    ...
    ttk.Entry(b3, width=entry_width, textvariable=answer).grid(row=3, column=1, sticky=tk.EW)
    ttk.Label(b3, text='B. ARM & WRIST ANALYSIS',
              font=(default_font, title_font_size)).grid(row=0, column=0, sticky=tk.NSEW)
    a1_step_images = [sm.ImageWidget(b3, './step8b-reba-images/reba-step8b-1.png', 'B', 0, 1, tk.BOTTOM, tk.NSEW),
    ...
    a1_step_options = [sm.ComboBoxWidget(b3, option_type,
    ...
    ttk.Label(b3, text='Step 8: Locate Lower Arm Position.',
