...
def create_page(master):
    ...
    a2_step_images = [sm.ImageWidget(a2, './step2a-reba-images/reba-step2a-1.png', 'C', 0, 1, tk.BOTTOM, tk.E),
                      sm.ImageWidget(a2, './step2a-reba-images/reba-step2a-2.png', 'B', 0, 1, tk.BOTTOM, tk.NSEW),
                      sm.ImageWidget(a2, './step2a-reba-images/reba-step2a-3.png', 'A', 0, 1, tk.BOTTOM, tk.W),
    ...
    sub_title = tk.Label(a2, text='Step 2: Locate trunk position.', font=(default_font, default_font_size))
