...
def create_page(master):
    ...
    tk.Label(a45, text='Step 4: Posture Score in Table A.',
    ...
    a5_step_option.button.grid(row=a5_step_option.row, column=a5_step_option.column,
                               sticky=a5_step_option.stick, padx=20)
